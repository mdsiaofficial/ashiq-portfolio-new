    ...
    <section id="experience" className="py-24 relative bg-slate-950">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative">
          <div className="absolute left-12 top-10 bottom-0 w-px bg-linear-to-b from-cyan-500 via-emerald-500 to-transparent hidden md:block" />
          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => (
              <motion.div
                ...
                className="relative"
              >
                <div className="md:absolute md:left-8 md:top-8 w-8 h-8 rounded-full bg-linear-to-r from-cyan-500 to-emerald-500 shadow-lg shadow-cyan-500/30 hidden md:block z-10" />
